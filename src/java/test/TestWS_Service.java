 ...
 * 
 */
@WebServiceClient(name = "TestWS", targetNamespace = "http://test.wx.com/", wsdlLocation = "http://localhost:8080/IS4227WineXpressWS-war/TestWS?WSDL")
    ...
    extends Service
{
    ...
    private final static QName TESTWS_QNAME = new QName("http://test.wx.com/", "TestWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/IS4227WineXpressWS-war/TestWS?WSDL");
    ...
    public TestWS getTestWSPort() {
        return super.getPort(new QName("http://test.wx.com/", "TestWSPort"), TestWS.class);
    }
    ...
    public TestWS getTestWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test.wx.com/", "TestWSPort"), TestWS.class, features);
    }
